...
ax.axhline(y=90, color="orange", linestyle="--", alpha=0.7, linewidth=1, label="90% Threshold")
...
# Add value labels on bars for months with <90% data
...
println("Months with <90% data: $(sum(all_monthly_stats.percent_valid .< 90))")
